...
message = tk.Label(window, text="Face-Recognition-Based-Automatic-Attendance-System" ,bg="Green"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
...
copyWrite.insert("insert", "Developed by Harish","", "TEAM", "superscript")
